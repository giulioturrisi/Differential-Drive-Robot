...
/*void re_decoder::_pulse(int gpio, int level, uint32_t tick) {
   ...
   if ((prevA == 1 && prevB == 1 && A == 1 && B == 0) ||
      (prevA == 1 && prevB == 0 && A == 0 && B == 0) ||
      (prevA == 0 && prevB == 0 && A == 0 && B == 1) ||
      (prevA == 0 && prevB == 1 && A == 1 && B == 1)) 
       (mycallback)(1);

   if ((prevA == 0 && prevB == 1 && A == 0 && B == 0) ||
      (prevA == 0 && prevB == 0 && A == 1 && B == 0) ||
      (prevA == 1 && prevB == 0 && A == 1 && B == 1) ||
      (prevA == 1 && prevB == 1 && A == 0 && B == 1)) 
       (mycallback)(-1);
