function [final_path] = planning_fun_Dijkstra(state_robot,dt,limit,goal,image,resolution,maxIter)

grid_search = Dijkstra(state_robot,dt,limit,goal,image,resolution,maxIter);
finish = 0;
while(finish == 0)
