classdef RRT_input_output < handle
    ...
    methods
        function obj = RRT_input_output(initial_state,sampling_time,limit,goal,map)
        ...
        function new_node = choose_primitives(obj,near_index, desired_node)
            ...
            b = 0.05;
            u1 = obj.k*(desired_node(1) - near_node(1));
            u2 = obj.k*(desired_node(2) - near_node(2));
