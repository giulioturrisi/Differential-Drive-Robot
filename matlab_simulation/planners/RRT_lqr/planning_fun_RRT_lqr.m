function [final_path] = planning_fun_RRT_lqr(state_robot,dt,limit,goal,image,resolution,maxIter)

RRT = RRT_lqr(state_robot,dt,limit,goal,image,resolution,maxIter);
